...
(function() {
  Formbuilder.registerField('text', {
    order: 0,
    view: "<input type='text' name='levani' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
    edit: "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
...
'\'\n  placeholder=\'დამატებითი აღწერა\'></textarea>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>მინიმალური / მაქსიმალური</div>\n\nAbove\n<input type="text" data-rv-input="model.' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>ტქსტის ლიმიტი</div>\n\nMin\n<input type="text" data-rv-input="model.' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>ველის ზომა</div>\n<select data-rv-value="model.' +
