...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 11 2016 г., 09:45
...
CREATE TABLE `events` (
  ...
  `agenda` text CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `events` (`id`, `event_name`, `photo`, `event_start_date`, `event_end_date`, `location`, `overview`, `form_id`, `lab_id`, `agenda`) VALUES
(13, 'Boosting Creativity', '12474013_916526235121358_401552391300193065_o.jpg', '2016-02-11 08:03:04', '2016-02-13 13:00:00', ' Merab Aleksidze St.8, 0160 Tbilisi, Georgia', 'დაუთმე შაბათი კრეატივს!\r\n\r\n13 თებერვალს, 12:00-დან 17:00-მდე მოდი ჯეოლაბში Creativity Boosting workshop-ზე, გაიგე, როგორ იფიქრო კრეატიულად და შენი წვლილი შეიტანე რეალური პრობლემის გადაჭრაში. \r\n\r\nსპიკერი: თემო ბარათაშვილი\r\n\r\nმონაწილეთა რაოდენობა შეზღუდულია, ამიტომ, იჩქარე და დარეგისტრირდი\r\nმონაწილეობა უფასოა.\r\n\r\n', '1', '1', '11:45-12:00\r\nმონაწილეთა რეგისტრაცია\r\n\r\n12:00-13:00\r\nსაუბარი კრეატიული აზროვნების შესახებ\r\n\r\n13:10-14:10\r\nსაუბარი კრეატიული პროცესის შესახებ\r\n\r\n14:10-14:40\r\nCoffee Break\r\n\r\n14:40-16:00\r\nარსებული პრობლემის გადასაჭრელად იდეების გენერირება\r\n\r\n16:10-16:45\r\nიდეების პრეზენტაცია \r\n');
